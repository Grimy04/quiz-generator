...
* **L'Interfaccia e la Struttura:** La struttura base del sito web (`index.html`) e il ragionamento logico dietro il design dell'interfaccia utente provengono dal fantastico lavoro di [@MerryDoThings], progetto [reti](https://github.com/MerryDoThings/reti.git). Un grande ringraziamento a lui per l'ottima base di partenza visiva!
